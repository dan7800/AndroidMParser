...
public class updateVersionOrder {
	...
	public static void main(String[] args) {
		...
		updateVersionOrder uvo = new updateVersionOrder();
		uvo.Run();
	}
	...
	private void Run(){
	    ...
	    Statement stmt = null;
		 try {
		    	...
		    	final String sqlAllApps="select * from version where isAPKExists=1";
		  //  	final String sqlAllApps="select * from dummy"; // temp information
		    	...
		    	ResultSet rsAllApps = stmt.executeQuery( sqlAllApps );
		    	 ...
		    	 while (rsAllApps.next()) {
		    		 ...
		    		 String sql="update version set versionCounter=" + counter + " where versionID= "+ rsAllApps.getString("versionID");
